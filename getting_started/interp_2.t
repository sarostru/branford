--[[
First try at annotating the interpreter for multistage programming like
in Taha's Gentle Intro to Multi Stage

Unfortunately, I think how I tried to do it here may not quite make sense.
...
op_table["if"] = 
	function(e, env)
		...
		quote
			var r = 0
			if [result[1]] then r = [eval(t_expr, env)[1]] 
			else r = [eval(f_expr, env)[1]] end
		in
			r
		end
		print("ifexpr: ", ifexpr)
